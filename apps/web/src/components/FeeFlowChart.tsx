    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="max-w-2xl mx-auto text-center mt-6 p-6 bg-purple-900/20 rounded-lg border border-purple-500/30">
        <p className="text-lg text-white">
          <span className="text-pink-400 font-bold">Trading fee (1%)</span> from all transactions don't go to the team or developers - 
          <span className="text-green-400 font-bold"> 100% goes to LOSER token stakers</span>.
        </p>
