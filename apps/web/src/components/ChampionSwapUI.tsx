    ...
    <DarkCard className="w-full">
      <CardHeader className="">
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-12 h-12 rounded-xl overflow-hidden border border-yellow-400/20 shadow-[0_0_15px_rgba(255,215,0,0.1)]">
            <Image
              src={coin.iconUrl}
              alt={coin.name}
              fill
          ...
          <div className="flex-1 min-w-0">
            <div className="font-bold text-xl truncate text-yellow-400 drop-shadow-[0_0_5px_rgba(255,215,0,0.2)]">
              {coin.name}
            </div>
          </div>
        </div>
