  ...
  return (
    <div className="min-h-screen pt-12 pb-28 bg-background">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* フォントサイズバランス調整 */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8">フォントサイズバランス調整</h2>
          <div className="grid grid-cols-3 gap-8">
            {/* パターンA: .WIN +6% */}
            <div className="bg-black/20 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-white mb-4">パターンA: .WIN +6%</h3>
              <div className="flex items-center gap-4">
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_6px_6px_0_#9400D3,_-6px_-6px_0_#9400D3,_6px_-6px_0_#9400D3,_-6px_6px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201] text-[1.06em] relative top-[4px]">.WIN</span>
                </h1>
              </div>
            ...
            {/* パターンB: .WIN +10% */}
            <div className="bg-black/20 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-white mb-4">パターンB: .WIN +10%（正式採用）</h3>
              <div className="flex items-center gap-4">
                <WordmarkLogo />
              </div>
            ...
            {/* パターンC: .WIN +15% */}
            <div className="bg-black/20 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-white mb-4">パターンC: .WIN +15%</h3>
              <div className="flex items-center gap-4">
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_6px_6px_0_#9400D3,_-6px_-6px_0_#9400D3,_6px_-6px_0_#9400D3,_-6px_6px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201] text-[1.15em] relative top-[4px]">.WIN</span>
                </h1>
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 gap-8">
            {/* パターンB: ml-2px（現状） */}
            <div className="bg-black/20 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-white mb-4">パターンB: ml-2px（現状）</h3>
              <div className="flex items-center gap-4">
            ...
            {/* パターンC: ml-0px（さらに詰める） */}
            <div className="bg-black/20 p-8 rounded-lg">
              <h3 className="text-xl font-bold text-white mb-4">パターンC: ml-0px（さらに詰める）</h3>
              <div className="flex items-center gap-4">
        ...
        {/* 白抜き縁取りバージョン */}
        <div className="mt-16">
          <h2 className="text-xl font-bold text-white mb-4">白抜き縁取りバージョン</h2>
          <div className="grid grid-cols-3 gap-8">
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                <span className="text-white text-2xl">1w.</span>
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#483D8B,_-2px_-2px_0_#483D8B,_2px_-2px_0_#483D8B,_-2px_2px_0_#483D8B]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#6A5ACD,_-2px_-2px_0_#6A5ACD,_2px_-2px_0_#6A5ACD,_-2px_2px_0_#6A5ACD]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#7B68EE,_-2px_-2px_0_#7B68EE,_2px_-2px_0_#7B68EE,_-2px_2px_0_#7B68EE]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#4169E1,_-2px_-2px_0_#4169E1,_2px_-2px_0_#4169E1,_-2px_2px_0_#4169E1]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#1E90FF,_-2px_-2px_0_#1E90FF,_2px_-2px_0_#1E90FF,_-2px_2px_0_#1E90FF]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#4B0082,_-2px_-2px_0_#4B0082,_2px_-2px_0_#4B0082,_-2px_2px_0_#4B0082]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#8A2BE2,_-2px_-2px_0_#8A2BE2,_2px_-2px_0_#8A2BE2,_-2px_2px_0_#8A2BE2]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#9370DB,_-2px_-2px_0_#9370DB,_2px_-2px_0_#9370DB,_-2px_2px_0_#9370DB]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#9400D3,_-2px_-2px_0_#9400D3,_2px_-2px_0_#9400D3,_-2px_2px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#9932CC,_-2px_-2px_0_#9932CC,_2px_-2px_0_#9932CC,_-2px_2px_0_#9932CC]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#C71585,_-2px_-2px_0_#C71585,_2px_-2px_0_#C71585,_-2px_2px_0_#C71585]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#DB7093,_-2px_-2px_0_#DB7093,_2px_-2px_0_#DB7093,_-2px_2px_0_#DB7093]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#FF1493,_-2px_-2px_0_#FF1493,_2px_-2px_0_#FF1493,_-2px_2px_0_#FF1493]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#FF69B4,_-2px_-2px_0_#FF69B4,_2px_-2px_0_#FF69B4,_-2px_2px_0_#FF69B4]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_2px_2px_0_#DDA0DD,_-2px_-2px_0_#DDA0DD,_2px_-2px_0_#DDA0DD,_-2px_2px_0_#DDA0DD]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
            </div>
        ...
        {/* 9wの縁取り太さバリエーション */}
        <div className="mt-16">
          <h2 className="text-xl font-bold text-white mb-4">9wの縁取り太さバリエーション</h2>
          <div className="grid grid-cols-3 gap-8">
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                <span className="text-white text-2xl">9w-1.</span>
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_1px_1px_0_#9400D3,_-1px_-1px_0_#9400D3,_1px_-1px_0_#9400D3,_-1px_1px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_3px_3px_0_#9400D3,_-3px_-3px_0_#9400D3,_3px_-3px_0_#9400D3,_-3px_3px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_4px_4px_0_#9400D3,_-4px_-4px_0_#9400D3,_4px_-4px_0_#9400D3,_-4px_4px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_5px_5px_0_#9400D3,_-5px_-5px_0_#9400D3,_5px_-5px_0_#9400D3,_-5px_5px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_7px_7px_0_#9400D3,_-7px_-7px_0_#9400D3,_7px_-7px_0_#9400D3,_-7px_7px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_8px_8px_0_#9400D3,_-8px_-8px_0_#9400D3,_8px_-8px_0_#9400D3,_-8px_8px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-6xl font-satoshi font-extrabold italic [transform:scaleX(0.8)]">
                  <span className="text-white [text-shadow:_9px_9px_0_#9400D3,_-9px_-9px_0_#9400D3,_9px_-9px_0_#9400D3,_-9px_9px_0_#9400D3]">BUMP</span>
                  <span className="text-[#FED201]">.WIN</span>
                </h1>
              </div>
            </div>
        ...
        {/* 字詰めバリエーション比較 */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8">字詰めバリエーション比較</h2>
          <div className="mb-8">
            <h3 className="text-xl font-bold text-white mb-4">パターンB: .WIN +10%</h3>
