    ...
    >
      ...
      <div
        className={cn(
          ...
          round.state === 'active' ? "bg-purple-500 animate-pulse" : "bg-gray-700",
        )}
      />
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className={cn(
            "text-6xl font-black",
            round.state === 'active' ? "text-purple-400" : round.state === 'ended' ? "text-gray-600" : "text-gray-700"
          )}>
            #{round.round}
          </div>
          ...
          <div className="flex items-start">
            ...
            {(round.state === 'ended' || round.state === 'active') && (
              <div className="w-[320px]">
                {round.state === 'ended' && (
                  <ChampionCard round={round} mockCoinMetadata={mockCoinMetadata} />
                )}
                {round.state === 'active' && (
