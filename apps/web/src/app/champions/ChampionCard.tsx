...
export const ChampionCard: React.FC<ChampionCardProps> = ({
  ...
  <Link href="/champions/1">
    <div className="relative aspect-[3/4] overflow-hidden rounded-xl shadow-2xl border border-yellow-500/30 bg-gray-900 transition-transform duration-200 hover:scale-[1.03] hover:shadow-3xl group cursor-pointer">
      {/* 右上順位バッジ */}
      {typeof rank === "number" && (
